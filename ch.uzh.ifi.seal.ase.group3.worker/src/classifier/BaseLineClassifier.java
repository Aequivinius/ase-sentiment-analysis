...
public class BaseLineClassifier implements IClassifier {
	...
	public void evaluate() throws Exception {
		...
		FileInputStream fstream = new FileInputStream(ClassifierBuilder.RESOURCE_PATH + "test_base.txt");
		DataInputStream in = new DataInputStream(fstream);
		BufferedReader br = new BufferedReader(new InputStreamReader(in));
		List<String> res_pos = new LinkedList<String>();
		List<String> res_neg = new LinkedList<String>();
		res_pos = extractFeatures(ClassifierBuilder.RESOURCE_PATH + "pos.txt");
		res_neg = extractFeatures(ClassifierBuilder.RESOURCE_PATH + "neg.txt");
		int pos = 0;
		int neg = 0;
		String strLine, pol;
		int i = 0;

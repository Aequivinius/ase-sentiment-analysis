...
public class WekaClassifier implements IClassifier, Serializable {
	...
	public WekaClassifier() throws Exception {
		DataSource source_train = new DataSource(ClassifierBuilder.RESOURCE_PATH + "train1.arff");
		DataSource source_test = new DataSource(ClassifierBuilder.RESOURCE_PATH + "test1.arff");

...
public class BaseLineClassifier implements IClassifier {
	...
	public void evaluate() throws Exception {
		...
		res_pos = extractFeatures(ServletFileUtil.getInstance().getFileStream("pos.txt"));
		res_neg = extractFeatures(ServletFileUtil.getInstance().getFileStream("neg.txt"));
		int pos = 0;
		int neg = 0;
		String strLine, pol;
		int i = 0;
	 ...
	 * 
	 * @param inputStream path of file from which terms can be extracted
	 * @return a list of terms
	 */
	public List<String> extractFeatures(InputStream inputStream) {

...
public class WekaClassifier implements IClassifier, Serializable {
	...
	public WekaClassifier() throws Exception {
		DataSource source_train = new DataSource(ServletFileUtil.getInstance().getFileStream("train1.arff")
				.toString());
		DataSource source_test = new DataSource(ServletFileUtil.getInstance().getFileStream("test1.arff")
				.toString());

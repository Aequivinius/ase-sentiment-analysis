package ch.uzh.ifi.seal.ase.group3.model;
...
public class Preprocessor {
	 ...
	 */
	public static String removeUsername(String item) {
		String result = "";
		if (item.startsWith("@"))
			result = "USERNAME";
		else
	 ...
	 */
	public static String removeUrl(String item) {
		String result = "";
	 ...
	 * 
	 * @param item the tweet to modify
	 * @return the tweet with "_SMILEHAPPY_" in place of happy emoticons and "_SMILESAD_" in place of sad
	 *         emticons
	 */
	public static String replaceEmoticons(String item) {
		String result = item;
	 ...
	 */
	public static String removeEmoticons(String item) {
		String result = item;
	 ...
	 */
	public static String removeRepeatedCharacters(String item) {
		String result = item;
	 ...
	 */
	public static String removeSymbols(String item) {
		String result = item;
		result = result.replaceAll("&quot;", "\"");
		result = result.replaceAll("&amp;", "&");
		result = result.replaceAll("&lt;", "<");
	 ...
	 */
	public static String recognizeLaugh(String item) {
		String result = item;
	 ...
	 */
	public static String preprocessDocument(String item) {
		String result_fin = "";
		String result = item;
